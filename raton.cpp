...
//deberia modificar aqui el estado
			//kf.statePre= deberia ser la función evaluada en el estado anterior y en uk pero aqui tampoco tengo señales de control, ni tengo la funcion, como la cambio?
...
//kf.statePost =kf.statePre+kf.gain*(medida-h (evaluada en el estado anterior))
